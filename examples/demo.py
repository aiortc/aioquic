...
async def handle_root_post_upload(request):
    ...
    print(f"DEMO_UPLOAD: Initial filepath from URL = '{filepath}'") # New log
    if filepath.startswith("upload/"):
        original_filepath_for_log = filepath # Save for logging
        ...
        if not filepath: # e.g. if original path was "upload/"
            ...
            pass
        print(f"DEMO_UPLOAD: Stripped 'upload/' prefix from '{original_filepath_for_log}'. New filepath = '{filepath}'") # New log
